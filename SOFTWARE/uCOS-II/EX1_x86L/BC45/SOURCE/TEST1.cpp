...
void  main (void)
{
 ...
 //	 OSTaskCreate(TaskStart, (void *)0, &TaskStartStk[TASK_STK_SIZE - 1], 0);
  	 OSTaskCreate(Task1, (void *)0, &TaskStartStk[TASK_STK_SIZE - 1], 9);
  	 OSTaskCreate(Task2, (void *)0, &TaskStartStk[TASK_STK_SIZE - 1], 8);
...
/*static  void  TaskStartCreateTasks (void)
{
 ...
 //	OSTaskCreate (task2, void (*) 0,(void *)&task2Stack [task2StackSize], task2Priority);
	OSTaskCreate (Task1,(void *)0, &TaskStartStk[TASK_STK_SIZE],1);
	OSTaskCreate (Task2,(void *)0, &TaskStartStk[TASK_STK_SIZE],2);
